            ...
            <div class="row py-lg-5">
                    ...
                    <div v-for="(vp_result, vp_idx) in result.vps" :key="vp_idx">
                        ...
                        <div v-for="data in vp_result.vp.verifiableCredential" id="accordion1" v-bind:key="data.id"
                            ...
                            <div class="accordion-item">
                                <h2 :id="'heading'+vp_result.vp.verifiableCredential.indexOf(data)"
                                    class="accordion-header">
                                    <button :aria-controls="'collapse'+vp_result.vp.verifiableCredential.indexOf(data)"
                                            :data-bs-target="'#collapse'+vp_result.vp.verifiableCredential.indexOf(data)"
                                ...
                                <div :id="'collapse'+vp_result.vp.verifiableCredential.indexOf(data)"
                                     :aria-labelledby="'heading'+vp_result.vp.verifiableCredential.indexOf(data)"
                        ...
                        <div v-if="vp_result.verification_result.valid" class="alert alert-success mt-4" role="alert">
                            <strong>The verification was successful</strong> <br> Verification Policies <br>
                            {{ JSON.stringify(vp_result.verification_result.policyResults, undefined, 2) }}
                        </div>
                        <div v-else class="alert alert-danger mt-4" role="alert">
                            <strong>The verification failed</strong> <br> Verification Policies <br>
                            {{ JSON.stringify(vp_result.verification_result.policyResults, undefined, 2) }}
                        </div>
                    </div>
                    <div v-if="result.isValid" class="alert alert-secondary mt-4" role="alert">
                        Authenticated session established <br> <span>
                <i class="bi bi-dot"></i>
                <a v-if="authenticatedDID === 'View authenticated DID'" class="text-dark" href="#"
                   @click="viewAuthenticatedDID">View authenticated DID</a>
                <a v-else class="text-dark" href="#" @click="viewAuthenticatedDID">{{
                        authenticatedDID.slice(0, 30)
                    }}...</a>
              </span> <br> <span>
                <i class="bi bi-dot"></i>
                <a v-if="access_token === 'View session token'" class="text-dark" href="#" @click="viewSessionToken">View session token</a>
                <a v-else class="text-dark" href="#" @click="viewSessionToken">{{ access_token.slice(0, 30) }}...</a>
                    ...
                    <div v-else class="alert alert-secondary mt-4" role="alert">
                        No authenticated session established! <br> <span>
                <i class="bi bi-dot"></i>
