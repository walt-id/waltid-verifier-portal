        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
                <h2 class="text-2xl leading-7 font-semibold">
                    Welcome to your Nuxt Application </h2>
                ...
                <p class="mt-4 pt-4 text-gray-800 border-t border-dashed">
                    ...
                    <code class="bg-gray-100 text-sm p-1 rounded border">pages/index.vue</code>. Have fun! </p>
            </div>
            <div class="flex justify-center pt-4 space-x-2">
                <a href="https://github.com/nuxt/nuxt.js" target="_blank">
                    <svg aria-hidden="true" class="w-6 h-6 text-gray-600 hover:text-gray-800"
                ...
                </a> <a href="https://twitter.com/nuxt_js" target="_blank">
                <svg aria-hidden="true" class="w-6 h-6 text-gray-600 hover:text-gray-800"
                     height="32" preserveAspectRatio="xMidYMid meet" role="img" viewBox="0 0 24 24" width="32"
                     xmlns="http://www.w3.org/2000/svg">
                    <path
